...
export default function Services(){
    return(
        <>
        <Navlight/>
        <section className="relative table w-full py-32 bg-top bg-no-repeat bg-cover lg:py-40" style={{backgroundImage:"url('/images/portfolio/bg-inner.jpg')"}}>
        <div className="absolute inset-0 bg-gradient-to-b from-black/60 via-black/80 to-black"></div>
        <div className="container relative">
            <div className="grid grid-cols-1 pb-8 mt-10 text-center">
                <h3 className="text-3xl font-medium leading-normal text-white">Our Services</h3>
            </div>
        </div>
        
        <div className="absolute z-10 mx-3 text-center bottom-5 start-0 end-0">
            <ul className="tracking-[0.5px] mb-0 inline-block">
                <li className="inline-block capitalize text-[14px] duration-500 ease-in-out text-white/50 hover:text-white"><Link href="/">Sdornala</Link></li>
